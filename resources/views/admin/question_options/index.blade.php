...
<div class="card">
    <div class="card-header" style="background-color: #1E40AF; color: #FFFFFF;">
        <h5 class="mb-0">Question Option</h5>
    </div>
    ...
    <div class="card-body">
        <div class="title d-flex justify-content-between">
            ...
            <p >
                <a href="{{ route('admin.question_options.create') }}" class="btn btn-success" style="background-color: #FFA000; border-color: #FFA000;">Add New</a>
            </p>
            @endcan
        </div>
                ...
                <tbody>
                    ...
                    <tr data-entry-id="{{ $question_option->id }}">
                        ...
                        <td>
                            ...
                            @else
                            <a class="btn btn-xs btn-info" href="{{ route('admin.question_options.edit', $question_option->id) }}" style="background-color: #1E40AF; border-color: #1E40AF; color: #FFFFFF">Edit</a>
