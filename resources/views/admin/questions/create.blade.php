...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.questions.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card card-footer" style="border-color: #1E88E5;">
                <div class="card-body">
                    <div class="row">
                        <div class="col-xs-12 col-12 form-group {{ $errors->has('option_text') ? 'has-error' : '' }}">
                            <label for="option_text">Option Text*</label>
                            <textarea id="option_text" name="{{ 'option_text_'. $question }}" rows="5" style="width: 100%;" class="form-control" required>{{ old('question', isset($question) ? "" : null) }}</textarea>
